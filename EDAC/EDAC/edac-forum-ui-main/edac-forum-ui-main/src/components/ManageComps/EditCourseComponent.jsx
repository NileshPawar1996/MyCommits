...
import { CREATE_COURSE, GET_COURSE, MANAGEMENT_URL } from '../../config';
...
export default function EditCourseComponent(props) {
  ...
  useEffect(() => {
    axios.get(MANAGEMENT_URL + GET_COURSE + props.id, {
    })
  ...
  function addCourse() {
    ...
    axios.post(MANAGEMENT_URL + CREATE_COURSE, {
      ...
      .then(function (response) {
        setMessageState({ message: "Course Edited Successfully", type: "success" });
